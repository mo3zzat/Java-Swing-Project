 ...
 */
public class Emp_UpdatePanel extends javax.swing.JPanel {

    /**
     * Creates new form Prof_AddPanel
     */
    public Emp_UpdatePanel() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBoxDept.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Student Affairs", "Staff Affairs" }));
    ...
    protected void setPanelData(Employee x) {
        ...
        if (x.myDept.getDeptName().equals("Student Affairs")) {
            jComboBoxDept.setSelectedIndex(0);
        } else if (x.myDept.getDeptName().equals("Staff Affairs")) {
