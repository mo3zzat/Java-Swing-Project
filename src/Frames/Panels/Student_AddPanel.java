...
public class Student_AddPanel extends javax.swing.JPanel {
     ...
     */
    public void init(){
        jTextFieldID.setText(student.getMAxID() + "");
    }
            ...
            if (!x.isIDExist(id)) {
                if (!x.isEmailExist(username)) {
                    ...
                    if (x.addStudent()) {
                        ...
                        resetPanelData();
                        jTextFieldID.setText(student.getMAxID() + "");
                        new Student_ListPanel().addRowsTojTable();
                    } else {
                        JOptionPane.showMessageDialog(this, "Failed to insert ... !");
                    }
                }else{
                    JOptionPane.showMessageDialog(this, "Student Username is Exist");
                }
            } else {
                JOptionPane.showMessageDialog(this, "Student id is Exist");
            }

        } else {
            JOptionPane.showMessageDialog(this, "Missing required Fields ... !  Please, complete them before submit ...!");
        }
